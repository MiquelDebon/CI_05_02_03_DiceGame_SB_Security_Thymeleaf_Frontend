...
//        Mockito.when(playerRepositorySQL.findById(anyInt())).thenReturn(Optional.of(player1));
//        Mockito.when(passwordEncoder.encode(anyString())).thenReturn(anyString());
//
//        PlayerGameDTO updatedPlayer = underTestService.updatePlayer(registerRequest, player1.getId());
//
